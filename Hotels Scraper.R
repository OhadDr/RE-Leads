...
# Permissions
# rtxt <- get_robotstxt("www.hotels.com")
# rtxt
...
remDr$open()
url_hotels <- "https://www.hotels.com/search.do?resolved-location=CITY%3A1401516%3AUNKNOWN%3AUNKNOWN&destination-id=1401516&q-destination=Boston,%20Massachusetts,%20United%20States%20of%20America&q-check-in=2019-08-18&q-check-out=2019-08-19&q-rooms=1&q-room-0-adults=2&q-room-0-children=0"
...
params_loc <- list(h_name,curr_id,star_rating,h_coord,num_of_rooms,rest_bar_lounge,
